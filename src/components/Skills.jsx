  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-4 relative z-10">
        <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#00FF6615] border border-[#00FF6630] group-hover:border-[#00FF66] group-hover:shadow-[0_0_10px_#00FF6640] transition-all">
          <skill.icon className="text-[#00FF66] text-lg" />
        </div>
        <span className="font-[Orbitron] text-sm font-semibold text-[#00FF66] uppercase tracking-wider">
          {skill.name}
        </span>
      </div>

      <div className="relative z-10">
        <div className="w-full h-[4px] bg-[#0a0a0a] rounded-full overflow-hidden">
          <motion.div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-0">
        ...
        <div>
          <div className="mb-24 pt-10">
            <div className="w-full h-[1px] bg-[#00FF6620] mb-10" />
            <h3 className="font-[Orbitron] text-sm font-bold text-[#00FF66] uppercase tracking-widest mb-10 flex items-center gap-3">
              <span className="w-10 h-[1px] bg-[#00FF66]" style={{ boxShadow: '0 0 5px #00FF66' }} />
              Technical Skills
            </h3>
          </div>
